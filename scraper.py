try:
    ...
    print("Error importing Cinemagoer:", e)
    print("Try running: pip uninstall cinemagoer IMDbPY && pip install cinemagoer")
    exit(1)
...
def get_movies(num_movies=250):
    print("Initializing Cinemagoer...")  # Debug print
    ia = Cinemagoer()
    try:
        movies = []  # Fixed: movies was incorrectly assigned to top_movie_ids
        top_movie_ids = [
        ...
        for movie_id in top_movie_ids:
            try:
                ...
                save_movies_to_file(movies, 'movies.json')
